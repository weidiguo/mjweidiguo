export default {
    ...
    "mj": {
        ...
        "infoStar": 'Ce projet est open source sur <a class="text-blue-600 dark:text-blue-500" href="https://www.weidiguo.cn\" target="_blank">微帝国官网</a>, gratuit et basé sur la licence MIT sans aucune forme de paiement ! </p><p>Si vous trouvez ce projet utile, veuillez lui donner une étoile sur 微帝国官网, merci !',
